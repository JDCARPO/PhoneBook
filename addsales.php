...
if(isset($_POST['Submit'])) {	
	...
	$result = mysqli_query($db, "INSERT INTO sales(id, customer_id, Date, login_id) VALUES('$id', '$description', '$price', '$unit', '$loginId')");
	...
	<form action="add.php" method="post" name="form1">
		<div class="form-group row">
			<label for="colFormLabel" class="col-sm-2 col-form-label">Date</label>
				<div class="col-sm-5">
					<input type="timestamp" name="Date" class="form-control" id="colFormLabel" required>
				</div>
		</div>
		<div class="form-group row">
